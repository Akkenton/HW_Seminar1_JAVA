...
// Сложные конструкции if else. Мне кажется это сильный перегруз.
// Буду благодарен за помощь - в каком направлении копать, чтобы сделать много проще.

// Сначала преобразовываем пользовательскую строку-уравнение в массив символов.
// после разбиваем на три переменные - firstCount, secondCount и resultCount
// Происходит анализ позиций знака ? в массиве в перменныех firstCount и secondCount.
// После, в зависимости от индекса 0 или 1 стрятся логические конструкции по расчету.
